...
################################################################################################
        ...
        self.g_2.adiciona_aresta("a1", "X", "Y", 1)
        self.g_2.adiciona_aresta("a2", "Y", "Z", 1)
        self.g_2.adiciona_aresta("a3", "Z", "W", 1)
        self.g_2.adiciona_aresta("a4", "W", "X", 1)
        self.g_2.adiciona_aresta("a5", "W", "Y", 1)
