...
##################################################################################################################
        ...
        self.g_b.adiciona_vertice("A")
        self.g_b.adiciona_vertice("B")
        self.g_b.adiciona_vertice("C")

        self.g_b.adiciona_aresta("a1", "A", "B", 3)
        self.g_b.adiciona_aresta("a2", "B", "C", 2)
        self.g_b.adiciona_aresta("a3", "C", "B", -6)

        self.g_b2 = MeuGrafo()

        self.g_b2.adiciona_vertice("A")
        self.g_b2.adiciona_vertice("B")
        self.g_b2.adiciona_vertice("C")

        self.g_b2.adiciona_aresta("a1", "A", "B", 3)
        self.g_b2.adiciona_aresta("a2", "B", "C", -5)
        self.g_b2.adiciona_aresta("a3", "C", "A", 1)

        self.g_b3 = MeuGrafo()

        self.g_b3.adiciona_vertice("A")
        self.g_b3.adiciona_vertice("B")
        self.g_b3.adiciona_vertice("C")
        self.g_b3.adiciona_vertice("D")
        self.g_b3.adiciona_vertice("E")
        self.g_b3.adiciona_vertice("F")

        self.g_b3.adiciona_aresta("a1", "A", "B", 2)
        self.g_b3.adiciona_aresta("a2", "B", "C", 2)
        self.g_b3.adiciona_aresta("a3", "C", "D", 2)
        self.g_b3.adiciona_aresta("a4", "C", "F", 1)
        self.g_b3.adiciona_aresta("a5", "F", "E", -7)
        self.g_b3.adiciona_aresta("a6", "E", "B", 1)

        self.g_b4 = MeuGrafo()

        self.g_b4.adiciona_vertice("A")
        self.g_b4.adiciona_vertice("B")
        self.g_b4.adiciona_vertice("C")
        self.g_b4.adiciona_vertice("D")
        self.g_b4.adiciona_vertice("E")
        self.g_b4.adiciona_vertice("F")

        self.g_b4.adiciona_aresta("a1", "A", "B", 5)
        self.g_b4.adiciona_aresta("a2", "B", "C", 2)
        self.g_b4.adiciona_aresta("a3", "C", "D", 4)
        self.g_b4.adiciona_aresta("a4", "B", "E", -6)
        self.g_b4.adiciona_aresta("a5", "E", "C", 3)
        self.g_b4.adiciona_aresta("a6", "E", "F", 2)
        self.g_b4.adiciona_aresta("a7", "F", "E", -4)

        self.g_d5 = MeuGrafo()

        self.g_d5.adiciona_vertice("I")
        self.g_d5.adiciona_vertice("A")
        self.g_d5.adiciona_vertice("B")
        self.g_d5.adiciona_vertice("C")
        self.g_d5.adiciona_vertice("D")
        ...
        self.g_d5.adiciona_aresta("a1", "I", "A", 10)
        self.g_d5.adiciona_aresta("a2", "I", "E", 8)
        self.g_d5.adiciona_aresta("a3", "E", "D", 1)
        self.g_d5.adiciona_aresta("a4", "B", "A", 1)
        self.g_d5.adiciona_aresta("a5", "D", "A", -4)
        self.g_d5.adiciona_aresta("a6", "A", "C", 2)
        self.g_d5.adiciona_aresta("a7", "D", "C", -1)
        self.g_d5.adiciona_aresta("a8", "C", "B", -2)

        self.g_b6 = MeuGrafo()

        self.g_b6.adiciona_vertice("I")
        self.g_b6.adiciona_vertice("A")
        self.g_b6.adiciona_vertice("B")
        self.g_b6.adiciona_vertice("C")
        self.g_b6.adiciona_vertice("D")
        self.g_b6.adiciona_vertice("E")

        self.g_b6.adiciona_aresta("a1", "A", "B", 5)
        self.g_b6.adiciona_aresta("a2", "B", "E", -4)
        self.g_b6.adiciona_aresta("a3", "D", "E", 7)
        self.g_b6.adiciona_aresta("a4", "D", "C", -20)
        self.g_b6.adiciona_aresta("a5", "C", "B", 3)
############################################################################################################
# Grafos com laco
    ...
    def test_bellman_ford(self):
        self.assertFalse((self.g_b.bellman_ford("A","C")))
        self.assertFalse((self.g_b2.bellman_ford("A","C")))
        self.assertFalse((self.g_b3.bellman_ford("A","E")))
        self.assertFalse((self.g_b4.bellman_ford("A","F")))
        self.assertEqual(self.g_d5.bellman_ford("I", "C"), ['I', 'E', 'D', 'A', 'C'])
        self.assertEqual(self.g_b6.bellman_ford("D", "B"), ['D', 'C', 'B'])